...
@team_bp.route('/code-overview')
@login_required
def code_overview():
    """Display code overview for the team functionality"""
    # Dictionary to store the file contents
    code_files = {}
    ...
    files_to_display = [
        ('Models', [
            ('team.py', os.path.join(base_dir, 'models', 'team.py')),
            ('player.py', os.path.join(base_dir, 'models', 'player.py'))
        ]),
        ('Routes', [
            ('team.py', os.path.join(base_dir, 'routes', 'team.py'))
        ]),
        ('Templates', [
            ('team/list.html', os.path.join(base_dir, 'templates', 'team', 'list.html')),
            ('team/create.html', os.path.join(base_dir, 'templates', 'team', 'create.html')),
            ('team/view.html', os.path.join(base_dir, 'templates', 'team', 'view.html')),
            ('team/add_player.html', os.path.join(base_dir, 'templates', 'team', 'add_player.html')),
            ('player/view.html', os.path.join(base_dir, 'templates', 'player', 'view.html')),
            ('player/routines.html', os.path.join(base_dir, 'templates', 'player', 'routines.html'))
        ])
    ]
    
    # Read the files
    for category, files in files_to_display:
        category_files = []
        ...
        code_files[category] = category_files
    
    return render_template('team/code_overview.html', code_files=code_files) 